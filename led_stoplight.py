...
num = 0
#Creates the variable that will store a value to deturmine how many 
# times the program repeats
n = 0
while n < 2:
	...
	#Changes the variable to keep the program from repeating forever
	n += 1
